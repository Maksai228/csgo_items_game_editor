...
# Устанавливаем строгий светлый дизайн с глубокими тёмно-синими акцентами
...
class ItemsGameEditor(ctk.CTk):
    def __init__(self):
        ...
        self.configure(fg_color="#F4F7F9") # Светлый премиальный фон всего окна
        
        self.resizable(False, False) 

        self.file_path = None
        
        # Словарь соответствия раритетности Valve внутренним токенам движка
        self.rarity_map = {
        ...
        # НЕИЗМЕНЯЕМЫЕ MASTER-СПИСКИ (Служат резервуаром для живого поиска)
        ...
        # Рабочие динамические списки для интерфейса
    ...
    def setup_ui(self):
        ...
        # Перекрашиваем вкладки через внутренний приватный объект CustomTkinter
    ...
    def setup_skin_tab(self):
        ...
        # Левая колонка: Органы управления
        ...
        # ФИКСИРОВАННАЯ СТРОКА ЧЕКБОКСА: Заменили 'checkbox_coor_color' на корректный 'fg_color'
        ...
        # Скрытый контейнер кастомных полей
        ...
        # Правая колонка: Профессиональная Консоль
